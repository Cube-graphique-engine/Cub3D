...
//	{
//		printf("ofuygerfl\n");
//		if (game->map->str_map[(int)((game->player->pos.vy - 0.1) * 0.5)] \
//        	[(int)(game->player->pos.vx * 0.5)] != '1')
//			return (1);
//	}
//	if (key == 1)
//	{
...
//	if (key == 2)
//	{
//		if (game->map->str_map[(int)(game->player->pos.vy * 0.5)] \
//			[(int)((game->player->pos.vx - 0.1) * 0.5)] != '1')
//			return (1);
//	}
//	if (key == 3)
//	{
