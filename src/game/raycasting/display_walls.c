...
/*   Updated: 2022/08/20 18:47:08 by mathismartini    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		return ;
//	dst = d->window->image->img_addr + (y * d->window->image->size_line + x * (d->window->image->bits_per_pixel / 8));
...
//		my_mlx_put_pixel(game, i.vx, i.vy, get_pixel_color(image, ray->tex_x, ray->tex_y));
